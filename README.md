...
1. **User Registration:** User registers and logs into the system.
2. **Authentication:** Security is verified using **JWT** (JSON Web Tokens).
3. **Socket Connection:** Users establish a connection to the **WebSocket** server.
4. **Real-time Messaging:** Messages are sent and received instantly.
5. **Data Persistence:** All messages are stored securely in **MongoDB**.
6. **Presence Tracking:** Online users are tracked and displayed in the UI.
...
## 👨‍💻 Author
Amit Raj (B.Tech / Computer Science Student)
